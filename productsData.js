const queryString = window.location.search; // Get the query string, e.g., '?name=kurklu-erkek-oduncu-gomlek'
const queryParams = new URLSearchParams(queryString); // Parse the query string into an object

    // access the value of the query parameters
...
/*   PRODUCTS*/
    ...
    // const product = products.find(p => p.name.toLowerCase() === (nameOfURL || '').toLowerCase());
...
document.addEventListener('DOMContentLoaded', function() { // bu kısım product-detail.html e eklemek için
        ...
        container.innerHTML = `
            <div class="row row-cols-1 row-cols-sm-1 row-cols-md-3 row-cols-lg-3 my-5 align-items-center justify-content-center g-3">
                ...
                <div class="col-12 col-lg-4 col-xl-4"> 
                    <div class="card border-0 shadow-sm rounded-3 h-100 transition-card">
                        <div class="position-relative">
                            <img src="${product.image1}"  class="card-img-top rounded-top-3 img-fluid"
                ...
                <div class="col-12 col-lg-4 col-xl-4"> 
                    <div class="card border-0 shadow-sm rounded-3 h-100 transition-card">
                        <div class="position-relative">
                            <img src="${product.image2}" class="card-img-top rounded-top-3 img-fluid"
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="d-flex align-items-center">
                                    <span class="display-6 fw-bold" style="color:pink;">${product.price}</span>
                                </div>
                                <hr style="width:100%; margin: 5px;">

                                <button class="sepeteEkle btn w-100 mt-3" style="background-color:pink; color:pink;">
...
/* filtreleme işlemine geçiyoruz filtrele ve   product.html de gçster*/
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productContainer) { // Sadece product.html sayfasında çalışacak kodlar
                                ...
                                <div class="card border-0 shadow-sm rounded-3 h-100 transition-card flex-fill">
                                    <div class="position-relative">
                                        ...
                                        <span class="position-absolute top-0 end-0 m-2 badge bg-light text-dark rounded-pill px-3 py-2 shadow-sm">
                                            <i class="fa-solid fa-palette me-1 text-primary"></i>${product.color}
                                        </span>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title fw-bold text-dark mb-1">${product.brand}</h5>
        ...
        //     // URL'i güncelle (page reload olmadan)
        //     const newUrl = `product.html?category=${encodeURIComponent(category)}`;
        //     history.pushState({ category }, '', newUrl);

        //     // Ürünleri göster
        //     displayProducts(category);
        //     syncFilterButtons(category);
        // });
        ...
        document.querySelectorAll('#category-filter-buttons .btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.querySelectorAll('#category-filter-buttons .btn').forEach(btn => {
        ...
        // Navbar'daki '.product > a[href="product.html"]' seçicisini kullanarak
        ...
        if (mainProductsLink) { // Linkin varlığını kontrol et
            mainProductsLink.addEventListener('click', function(event) {
                ...
                displayProducts(products); // Tüm ürünleri göster
            });
        }

        // Sayfa yüklendiğinde URL'deki kategori parametresini kontrol et
        ...
        if (initialCategory) {
            ...
            displayProducts(products); // Başlangıçta tüm ürünleri göster
        }
    }
});
